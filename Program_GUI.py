...
class aUI:
    ...
    def update(self):
        ...
        if self.thread_client is not None and self.thread_client.is_alive():
            if modbus.read_coil_call(self.client_instance.client, coil_addr['parar']):
                self.parar()
            elif modbus.read_coil_call(self.client_instance.client, coil_addr['reprog']):
                self.reprogramar()
            elif modbus.read_coil_call(self.client_instance.client, coil_addr['voltar']):
                self.desconectar()
        else:
            if self.ip is not None:
                client2 = modbus.ModbusTcpClient(self.ip)
                if modbus.read_coil_call(client2, coil_addr['iniciar']):
                    self.iniciar()
    ...
    def generate_problem(self):
        ...
        mem_words_addr = {
            'quantidade_caixa1_mg': 9, #40010
            'quantidade_caixa1_mm': 10, #40011
            'quantidade_caixa1_mp': 11, #40012
            'quantidade_caixa1_nmg': 12, #40013
            'quantidade_caixa1_nmm': 13, #40014
            'quantidade_caixa1_nmp': 14, #40015
            'quantidade_caixa2_mg': 15, #40016
            'quantidade_caixa2_mm': 16, #40017
            'quantidade_caixa2_mp': 17, #40018
            'quantidade_caixa2_nmg': 18, #40019
            'quantidade_caixa2_nmm': 19, #40020
            'quantidade_caixa2_nmp': 20, #40021
            'quantidade_caixa3_mg': 21, #40022
            'quantidade_caixa3_mm': 22, #40023
            'quantidade_caixa3_mp': 23, #40024
            'quantidade_caixa3_nmg': 24, #40025
            'quantidade_caixa3_nmm': 25, #40026
            'quantidade_caixa3_nmp': 26, #40027
        }


        #print(modbus.read_coil_call(self.client2, 23))
        #client2 = modbus.ModbusTcpClient(self.ip)
        for key in mem_words_addr:
            print(key,':', self.client_instance.client.read_holding_registers(address=mem_words_addr[key], count=1).registers[0])

        items = {

            'cx1_peq_metal': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa1_mp'], count=1).registers[0]) - self.caixa_descarte1['peca_peqmet'],
            'cx1_med_metal': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa1_mm'], count=1).registers[0]) - self.caixa_descarte1['peca_medmet'],
            'cx1_grd_metal': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa1_mm'], count=1).registers[0]) - self.caixa_descarte1['peca_grdmet'],
            'cx1_peq': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa1_nmp'], count=1).registers[0]) - self.caixa_descarte1['peca_peqnmet'],
            'cx1_med': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa1_nmm'], count=1).registers[0]) - self.caixa_descarte1['peca_mednmet'],
            'cx1_grd': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa1_nmg'], count=1).registers[0]) - self.caixa_descarte1['peca_grdnmet'],

            'cx2_peq_metal': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa2_mp'], count=1).registers[0]) - self.caixa_descarte2['peca_peqmet'],
            'cx2_med_metal': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa2_mm'], count=1).registers[0]) - self.caixa_descarte2['peca_medmet'],
            'cx2_grd_metal': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa2_mg'], count=1).registers[0]) - self.caixa_descarte2['peca_grdmet'],
            'cx2_peq': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa2_nmp'], count=1).registers[0]) - self.caixa_descarte2['peca_peqnmet'],
            'cx2_med': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa2_nmm'], count=1).registers[0]) - self.caixa_descarte2['peca_mednmet'],
            'cx2_grd': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa2_nmg'], count=1).registers[0]) - self.caixa_descarte2['peca_grdnmet'],

            'cx3_peq_metal': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa3_mp'], count=1).registers[0]) - self.caixa_descarte3['peca_peqmet'],
            'cx3_med_metal': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa3_mm'], count=1).registers[0]) - self.caixa_descarte3['peca_medmet'],
            'cx3_grd_metal': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa3_mg'], count=1).registers[0]) - self.caixa_descarte3['peca_grdmet'],
            'cx3_peq': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa3_nmp'], count=1).registers[0]) - self.caixa_descarte3['peca_peqnmet'],
            'cx3_med': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa3_nmm'], count=1).registers[0]) - self.caixa_descarte3['peca_mednmet'],
            'cx3_grd': int(self.client_instance.client.read_holding_registers(address=mem_words_addr['quantidade_caixa3_nmg'], count=1).registers[0]) - self.caixa_descarte3['peca_grdnmet']
